//  Made by amrshaheen61 (https://github.com/amrshaheen61)
//  Original code : https://github.com/amrshaheen61/Alan-Wake-2-RMDTOC-Tool/blob/master/Helper/DDSToBitmap.cs
        ...
        private static Bitmap GetBitMapFromDDS(DDSFormat format, IStream stream)
        {
            switch (format)
            {
                ...
                case DDSFormat.bc1_unorm_srgb:
                    //Console.WriteLine("DDS Format : DXT1");
                ...
                case DDSFormat.bc2_unorm_srgb:
                    //Console.WriteLine("DDS Format : DXT3");
                ...
                case DDSFormat.bc3_unorm_srgb:
                    //Console.WriteLine("DDS Format : DXT5");
